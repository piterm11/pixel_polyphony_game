        ...
        <div className="App">
            ...
            <div className = "xd"> 
                ...
                <form>
                    <label>
                        Nick: 
                        <input type="text" maxLength="14" spellCheck="false" name="nick" style={{width: '510px'}}/>
                        <br/>
                    </label>
                    <label>
                        Room Code: 
                        <input type="text" maxLength="6" spellCheck="false" name="code" style={{width: '250px'}}/>
                    </label>
                    <br/>
                </form>
            </div>
            <div className= "buttons">
                ...
                <div className="start" style= {xd} onClick={async () => {
